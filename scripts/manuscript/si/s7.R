...
human_readable_names <- c("Degree Centrality", "Closeness Centrality", "Eigenvector Centrality", "Betweenness Centrality", 
...
ggsave("figures/manuscript/si/figure_s7.jpeg", pca_biplot, width = 8.5, height = 4, units = "in", dpi = 1200)
