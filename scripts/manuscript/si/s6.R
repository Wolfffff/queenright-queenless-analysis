...
bds_means_unstandardized <- aggregate(cbind(UnStandardizedDegree, Close, Eigen, Between, QR, Queen, boutDegree, boutBetween, boutClose, boutEigen, bodyDegree, bodyBetween, bodyClose, bodyEigen, AverageBoutLength, Presence, AntPresence, mean_vel, move_perc, N90.Day4, MRSD.Day4, Initiation.Freq, clust, Disparity) ~ Bee, bds, mean)
...
final_plot <- plot_grid(plot_move_perc, plot_bouts,plot_unstd, ncol = 3)

ggsave("figures/manuscript/si/figure_s6.jpeg", plot = final_plot, width = 8.5, height = 4.25, dpi = 1200)
