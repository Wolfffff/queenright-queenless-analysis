...
# Read the dataset
wing_morphometrics <- read_csv("wing_morphometrics.csv")
...
combined_plot <- plot_grid(plot1, plot2, plot3, ncol = 3, align = "vh",
                           labels = c("a.", "b.", "c."), label_fontface = "bold", label_size = 14)

# Save the combined plot
ggsave("size_relationships.jpeg", combined_plot, width = 8.5, height = 4.5, dpi = 600)
