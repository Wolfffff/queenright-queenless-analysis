...
bds_means_unstandardized <- aggregate(cbind(
  ...
  move_perc, N90.Day4, MRSD.Day4, Initiation.Freq, clust
) ~ Bee, bds, mean)
...
bds_means_of_means_unstandardized <- aggregate(cbind(UnStandardizedDegree, Close, Eigen, Between, QR, Queen, boutDegree, boutBetween, boutClose, boutEigen, bodyDegree, bodyBetween, bodyClose, bodyEigen, AverageBoutLength, Presence, AntPresence, mean_vel, move_perc, N90.Day4, MRSD.Day4, Initiation.Freq, clust) ~ ID, bds_means_unstandardized, mean)
...
ggsave("figure_s6.jpeg", plot = final_plot, width = 8.5, height = 3, dpi = 600)
