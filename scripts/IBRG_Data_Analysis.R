...
# Dispersion vs Degree ----------

WorkerDisp = WorkerDisp
DegVel <- HeadDeg %>% right_join(TotalVel, by=c("ID", "Hour","Day","QR"))
...
DegVelMeanDayAL <- DegVelMeanDay[DegVelMeanDay$Col=="20221123_1543_AmericanoLatte_QR",]
...
DegVelMeanDayRT <- DegVelMeanDay[DegVelMeanDay$Col=="RooibosTea_QR_1216_1646",]
...
ggplot(Ovaries, aes(x=AverageOvaryLength)) + 
...
OvariesRT = Ovaries[Ovaries$Col == 'RooibosTea',]

ggplot(OvariesRT, aes(x=AverageOvaryLength)) + 
  geom_histogram(aes(color = factor(Treatment)))+
  theme_classic() + 
  labs(title="Average Length of Longest Oocyte")+
  scale_color_manual(name   ="Bee",
...
ggplot(OvariesRT, aes(x=AverageOvaryWidth)) + 
  geom_histogram(aes(color = factor(Treatment)))+
  theme_classic() + 
  labs(title="Average Length of Longest Oocyte")+
  scale_color_manual(name   ="Bee",
...
ggplot(Ovaries, aes(x=AverageOvaryWidth)) + 
  geom_histogram(aes(y = ..density.., color = factor(Treatment)))+
  ...
  scale_color_manual(name   ="Bee",
                     labels = c("QL", "QR"),
                     values = c("#161414", "#629CC0"))+
  facet_wrap(~ Treatment+Colony, nrow = 2)

res <- wilcox.test(AverageOvaryWidth ~ Treatment, data = Ovaries,
                   exact = FALSE)
res$p.value
...
ggplot(Ovaries, aes(x=AverageOvaryLength, y=AverageOvaryWidth)) + 
  geom_point() + 
  geom_smooth(method   = lm,
              se       = T, 
              size     = 1.5, 
...
DegOvMeanRT = merge(DegVelMeanRT, OvariesRT, by='ID')
...
ggplot(DegOvMeanRT, aes(x=AverageOvaryWidth, y=Degree)) + 
  geom_point() + 
  geom_smooth(method   = lm,
              se       = T, 
              size     = 1.5, 
...
ggplot(DegOvMeanRT, aes(x=AverageOvaryWidth, y=move_perc)) + 
  geom_point() + 
  geom_smooth(method   = lm,
              se       = T, 
              size     = 1.5, 
              ...
              aes(color    = factor(Treatment)))+
  theme_classic(base_size = 16) + 
  labs(title="RooTea: Degree vs Movement Percentage")+
  scale_color_manual(name   ="Bee",
                     labels = c("QL", "QR"),
                     values = c("#161414", "#629CC0"))+
  facet_wrap(~ Treatment, nrow = 2)
...
ddply(DegOvMeanRT, .(Col), summarise,
      corr=(cor.test(AverageOvaryWidth, Degree,
...
ddply(DegOvMeanRT, .(Col), summarise,
      corr=(cor.test(AverageOvaryWidth, move_perc,
                     alternative="two.sided", method="spearman")), name=names(corr) )

ggplot(DegOvMeanRT, aes(x=AverageOvaryWidth, y=mean_vel)) + 
  geom_point() + 
  geom_smooth(method   = lm,
              se       = T, 
              size     = 1.5, 
...
ggplot(HBOvMeanRT, aes(x=AverageOvaryWidth, y=Sum)) + 
  geom_point() + 
  geom_smooth(method   = lm,
              se       = T, 
              size     = 1.5, 
...
ggplot(HBOvMeanRT, aes(x=AverageOvaryWidth, y=InDegree)) + 
  geom_point() + 
  geom_smooth(method   = lm,
              se       = T, 
              size     = 1.5, 
...
ggplot(HBOvMeanRT, aes(x=AverageOvaryWidth, y=OutDegree)) + 
  geom_point() + 
  geom_smooth(method   = lm,
              se       = T, 
              size     = 1.5, 
...
ddply(HBOvMeanRT, .(Col), summarise,
      corr=(cor.test(AverageOvaryWidth, Sum,
                     alternative="two.sided", method="spearman")), name=names(corr) )
...
ggplot(DegOvMeanAM, aes(x=AverageOvaryWidth, y=Degree)) + 
  geom_point() + 
  geom_smooth(method   = lm,
              se       = T, 
              size     = 1.5, 
...
ggplot(DegOvMeanAGWorker, aes(x=AverageOvaryWidth, y=Degree)) + 
  geom_point() + 
  geom_smooth(method   = lm,
              se       = T, 
              size     = 1.5, 
...
ggplot(DegOvMeanALWorker, aes(x=AverageOvaryWidth, y=Degree)) + 
  geom_point() + 
  geom_smooth(method   = lm,
              se       = T, 
              size     = 1.5, 
...
ggplot(DegOvMeanMHCWorker, aes(x=AverageOvaryWidth, y=Degree)) + 
  geom_point() + 
  geom_smooth(method   = lm,
              se       = T, 
              size     = 1.5, 
...
Wings$AverageWingLength = (Wings$Wing1 + Wings$Wing2) / 2
Wings$ID = paste("RooibosTea_",Wings$Treatment,"_1216_1646_ArUcoTag#",Wings$Tag,sep="")
DegOvMeanRT = DegOvMeanRT[DegOvMeanRT$Col == 'RooibosTea_QR_1216_1646' | DegOvMeanRT$Col == 'RooibosTea_QL_1216_1646',]
OvWingMeanRT = merge(DegOvMeanRT, Wings, by='ID')

ggplot(OvWingMeanRT, aes(x=AverageOvaryWidth, y=AverageWingLength)) + 
  geom_point() + 
  geom_smooth(method   = lm,
              se       = T, 
              size     = 1.5, 
              linetype = 1, 
              alpha    = .7,
              aes(color    = factor(Treatment.x)))+
  theme_classic() + 
  labs(title="RooibosTea: Wing Length vs Ovary Width")+
  scale_color_manual(name   ="Bee",
                     labels = c("QL", "QR"),
                     values = c("#161414", "#629CC0"))+
  facet_wrap(~ Treatment.x, nrow = 2)

ggplot(OvWingMeanRT, aes(x=AverageWingLength, y=Degree)) + 
  geom_point() + 
  geom_smooth(method   = lm,
              se       = T, 
              size     = 1.5, 
              ...
              aes(color    = factor(Treatment.x)))+
  theme_classic() + 
  labs(title="RooibosTea: Wing Length vs Degree")+
  scale_color_manual(name   ="Bee",
                     labels = c("QL", "QR"),
                     values = c("#161414", "#629CC0"))+
  facet_wrap(~ Treatment.x, nrow = 2)

ggplot(OvWingMeanRT, aes(x=AverageWingLength)) + 
  geom_histogram(aes(y = ..density.., color = factor(Treatment.x)))+
  #geom_density(lwd = 1, colour = 1,
               #fill = 1, alpha = 0.25)+
  theme_classic() + 
  labs(title="Average Length of Marginal Cell")+
  scale_color_manual(name   ="Bee",
                     labels = c("QL", "QR"),
                     values = c("#161414", "#629CC0"))+
  facet_wrap(~ Treatment.x, nrow = 2)
...
DegVelDispWorkers = DegVelDisp[DegVelDisp$Queen == FALSE,]
ggplot(DegVelDispWorkers, aes(x=N90, y=Degree)) + 
  geom_point(aes(color    = factor(QR))) + 
  geom_smooth(method   = lm,
              se       = T, 
              size     = 1.5, 
              linetype = 1, 
...
for(i in 1:10){
  for(j in 1:34){
    if(file.exists(paste(prefixes[i],Days[j],"NWPBout.csv",sep = "_"))) {
      NWP = read.csv(paste(prefixes[i],Days[j],"NWPBout.csv",sep = "_"))
      NWP$Day = floor((j-1)/9)+1
      NWP$Hour = Days[j]
      NWP$Col = prefixes[i]
      NWP$QR = i %% 2 == 1
...
EnrichmentRoo = read.csv('EnrichmentRooibos.csv')
EnrichmentRoo <- separate(EnrichmentRoo, Int, into = c("Ori", "Des"), sep = "_")
EnrichmentRoo$OriID = paste("RooibosTea_QR_1216_1646_",EnrichmentRoo$Ori,sep="")
EnrichmentRoo$DesID = paste("RooibosTea_QR_1216_1646_",EnrichmentRoo$Des,sep="")
OvariesRT = Ovaries[Ovaries$Colony == 'RooibosTea' & Ovaries$Treatment == 'QR',]
OvariesSub = OvariesRT[, c('ID', 'AverageOvaryWidth')]

EnrichmentRooOv = EnrichmentRoo[EnrichmentRoo$OriID %in% OvariesRT$ID,]
EnrichmentRooOv = EnrichmentRooOv[EnrichmentRooOv$DesID %in% OvariesRT$ID,]


OriMerge <- merge(EnrichmentRooOv, OvariesSub, by.x = "OriID", by.y = "ID", all.x = TRUE)
names(OriMerge) <- c("OriID", "Index", "Ori","Des","Enriched","DesID","Width_Ori")
# Merge for Des column
DesMerge <- merge(EnrichmentRooOv, OvariesSub, by.x = "DesID", by.y = "ID", all.x = TRUE)
names(DesMerge) <- c("DesID", "Index", "Ori","Des","Enriched","OriID","Width_Des")


# Merge the two dataframes based on Ori and Des columns
EnrichmentOvMerge <- merge(OriMerge, DesMerge, by = c("OriID", "DesID"))
EnrichmentOvMerge$MeanOv = (EnrichmentOvMerge$Width_Ori + EnrichmentOvMerge$Width_Des)/2
EnrichmentOvMerge$DifOv = abs(EnrichmentOvMerge$Width_Ori - EnrichmentOvMerge$Width_Des)
ggplot(EnrichmentOvMerge, aes(x=Enriched.x, y=MeanOv)) + 
  geom_point() + 
  geom_smooth(method   = lm,
              se       = T, 
              size     = 1.5, 
              ...
              alpha    = .7)+
  theme_classic() + 
  labs(title="RooTea: Enrichment vs Avg Width")

ggplot(EnrichmentOvMerge, aes(x=Enriched.x, y=DifOv)) + 
  geom_point() + 
  geom_smooth(method   = lm,
              se       = T, 
              size     = 1.5, 
              ...
              alpha    = .7)+
  theme_classic() + 
  labs(title="RooTea: Enrichment vs Difference in Width")

cor.test(EnrichmentOvMerge$Enriched.x, EnrichmentOvMerge$MeanOv, alternative="two.sided", method="spearman")
